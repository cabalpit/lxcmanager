 ...
 *
 * \param parent waits parent \c QObject, default nullptr
 ...
 * \param comparison waits an Enum for comparison by default Equal comparision. To know about ComparisonType \c \see model::ComparisonType
 * \return \c QSqlQuery if rows found otherwize nullptr
 */
 ...
 * \param comparison waits an Enum for comparison by default Equal comparision. To know comparison type \see \c model::ComparisonType
 * \return \c QSqlQuery if rows found otherwize nullptr
 */
 ...
 * Overload method find
 *
 * \param clause waits WhereClause struct, \c \see model::WhereClause
 * \return \c QSqlQuery if rows found otherwize nullptr.
 */
 ...
 *
 * This method returns all rows from selected table, the \a limit and \a offset can be
 ...
 *
 * \param clause waits clause condition where to delete \c \see model::WhereClause.
 ...
 *
 * \param clauseList waits a list of WhereClause structure \c \see model::WhereClause
 ...
 *
 * This method trigger Log::WriteLog method to write the error from \c QSqlite
 *
